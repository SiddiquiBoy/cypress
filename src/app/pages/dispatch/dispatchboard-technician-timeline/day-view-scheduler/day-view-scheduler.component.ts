import { Component, OnInit, ViewEncapsulation, Injectable, OnChanges, Input, Output, EventEmitter, ChangeDetectorRef, Inject, LOCALE_ID, SimpleChanges } from '@angular/core';
import { WeekView, GetWeekViewArgs, WeekViewTimeEvent, WeekViewAllDayEvent } from 'calendar-utils';
import { CalendarUtils, CalendarWeekViewComponent, DateAdapter, CalendarEvent, getWeekViewPeriod } from 'angular-calendar';
