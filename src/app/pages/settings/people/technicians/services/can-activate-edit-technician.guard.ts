...
export class CanActivateEditTechnicianGuard implements CanActivate {
  ...
  canActivate(
    ...
    if (this.authenticationService.checkPermission(Permission.EDIT_TECHNICIAN)) {
      ...
      const nextRoute: string = this.mainUiService.getNextRoute(RouterConstants.SETTINGS_PEOPLE_TECHNICIANS);
      if (nextRoute) {
