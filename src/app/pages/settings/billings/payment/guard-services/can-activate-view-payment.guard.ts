...
export class CanActivateViewPaymentGuard implements CanActivate {
  constructor(
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
      if (this.authenticationService.checkPermission(Permission.VIEW_PAYMENT)) {
        ...
        const nextRoute: string = this.mainUiService.getNextRoute(RouterConstants.SETTINGS_BILLINGS_PAYMENT);
        if (nextRoute) {
