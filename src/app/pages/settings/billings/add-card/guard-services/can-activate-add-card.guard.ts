...
export class CanActivateAddCard implements CanActivate {
  constructor(
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
      if (this.authenticationService.checkPermission(Permission.ADD_CARD)) {
        ...
        const nextRoute: string = this.mainUiService.getNextRoute(RouterConstants.SETTINGS_BILLINGS_CARD);
        if (nextRoute) {
