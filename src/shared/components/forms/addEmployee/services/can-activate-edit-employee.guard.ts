...
export class CanActivateEditEmployeeGuard implements CanActivate {
  ...
  canActivate(
    ...
    if (this.authenticationService.checkPermission(Permission.EDIT_EMPLOYEE)) {
      ...
      const nextRoute: string = this.mainUiService.getNextRoute(RouterConstants.SETTINGS_PEOPLE_EMPLOYEES);
      if (nextRoute) {
